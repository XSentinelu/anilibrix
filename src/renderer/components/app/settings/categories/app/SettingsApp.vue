      ...
      return [
        {
          ...
          action: () =>
            require("@electron/remote").shell.openExternal(
              meta.links.anilibria
            ),
        },
        {
          ...
          action: () =>
            require("@electron/remote").shell.openExternal(meta.links.donate),
        },
        {
          title: "Telegram-канал",
          value: "@anilibrix",
          action: () =>
            require("@electron/remote").shell.openExternal(meta.links.telegram),
        },
        {
          title: "Исходный код",
          value: "/anilibrix",
          action: () =>
            require("@electron/remote").shell.openExternal(repository.url),
        },
      ];
    },
  },
